...
export default function DashboardPage() {
  ...
  const [newsSidebarWidth, setNewsSidebarWidth] = useState(400);
  ...
  const handleBoundsChange = useCallback(
    (bounds: L.LatLngBounds) => {
      ...
      // Kalau map berubah area, kembali ke halaman pertama
      setCurrentPage(1);
    },
    []
  );
    ...
    <div className="h-screen overflow-hidden bg-zinc-950 text-white flex">
      ...
      <main className="flex-1 min-w-0 flex flex-col">
        ...
        <div className="flex-1 min-h-0 p-4 flex gap-4">
          ...
          <NewsSidebar
            width={newsSidebarWidth}
            onWidthChange={setNewsSidebarWidth}
